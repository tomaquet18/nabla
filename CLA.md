...
protects you as a contributor as well as the Licensor and the Project's users;
...
behalf of your employer or another entity, make sure you are authorized to do
so; the representations in section 4 apply to that entity as well.

## 1. Definitions

"You" (or "Your") means the copyright owner or legal entity authorized by the
copyright owner that is entering into this Agreement with the Licensor. For
...
by You to the Licensor for inclusion in, or documentation of, any of the
products owned or managed by the Licensor (the "Work"). "Submitted" means any
form of electronic, verbal, or written communication sent to the Licensor or
its representatives, including but not limited to pull requests, patches, issue
comments and mailing lists, but excluding communication that is conspicuously
...
any license, including licenses that differ from the license under which the
...
1. You are legally entitled to grant the above licenses. If Your employer(s)
   ...
   has executed a separate agreement with the Licensor.
...
3. To the extent a Contribution includes work that is not Your original
   creation, You submit it separately from any Contribution, identify the
   complete details of its source and of any license or other restriction of
   which You are personally aware, and conspicuously mark the work as
...
This Agreement covers Contributions to every component of the Project,
regardless of the license under which that component is distributed (see the
"License" section of the README). Your Contribution remains yours; you may use
it elsewhere under any terms you like.

## How to sign

Signing is done once, on your first pull request. Post the following comment on
the pull request, exactly:

    I have read the CLA Document and I hereby sign the CLA

The signature is recorded automatically and applies to all your future
contributions. Pull requests from contributors who have not signed cannot be
merged.
